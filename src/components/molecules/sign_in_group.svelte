...
<button
	type="button"
	class="mr-2 mb-2 inline-flex items-center rounded-lg bg-[#24292F] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-none focus:ring-4 focus:ring-[#24292F]/50 dark:hover:bg-[#050708]/30 dark:focus:ring-gray-500"
...
<button
	type="button"
	class="mr-2 mb-2 inline-flex items-center rounded-lg bg-[#fc6d26] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#fc6d26]/90 focus:outline-none focus:ring-4 focus:ring-[#fc6d26]/50 dark:hover:bg-[#fc6d26]/30 dark:focus:ring-gray-500"
	on:click={() => gotoAuthProvider('gitlab')}
>
	<svg
		class="mr-2 -ml-1 h-4 w-4"
		aria-hidden="true"
